...
subplot(122); plot(basefluor);xlabel('Slice');title('Estimated background fluorescence');
%% image correction
...
% figure; subplot(121); imagesc(IF(:,:,20));colormap('gray');title('Original image');
% subplot(122);imagesc(IF_corr(:,:,20));colormap('gray');title('BaSiC corrected image');